...
You can also customise this boxplot. Just add any arguments that you would usually pass to `boxplot()`. See `?boxplot()` for infos. Next to changing labels and the title, you may find notched boxplots quite appealing.

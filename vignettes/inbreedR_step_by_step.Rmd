...
```{r, results = "hide"}
g2_seal_snps <- g2_snps(seal_snps, nperm = 100, nboot = 100, CI = 0.95)
```
...
```{r}
dim(seal_snps) # 14586 loci
system.time(sMLH(seal_snps))
```

...
`inbreedR` also provides a simulation function to estimate the precision of g2 for different marker subsets. The idea is to
draw independent subsets of loci from 

```{r, echo=TRUE, results='hide'}
sim_g2 <- simulate_g2(n_ind = 20, subsets = c(4,6,8,10,12), reps = 100, genotypes = mouse_microsats)
```

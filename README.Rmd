...
[![](http://cranlogs.r-pkg.org/badges/grand-total/inbreedR)](https://cran.r-project.org/web/packages/inbreedR/index.html)
...
If you encounter bug or if you have any suggestions for improvement, just contact me: 

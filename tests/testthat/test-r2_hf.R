...
test_that("nboot = 0 works", {
    expect_equal(r2_hf(msats, subsets = c(2,4,10), nboot_loci = 0, type = "msats")$r2_hf_full, 0.2797, 
                 tolerance = 0.001)
    expect_equal(r2_hf(snps, subsets = c(2,4,10), nboot_loci = 0, type = "snps")$r2_hf_full, 0.6698, 
                 tolerance = 0.001)
})
...
test_that("Matrix input works", {
    ...
    expect_equal(r2_hf(as.matrix(snps), subsets = c(2,4,10), nboot_loci = 0, type = "snps")$r2_hf_full, 
